...
{c.telefone && (
  <a href={`https://wa.me/55${c.telefone.replace(/\D/g,'')}`} target="_blank" rel="noreferrer"
    style={{ display:'inline-flex', alignItems:'center', gap:4, padding:'5px 10px', borderRadius:6, background:'#25d366', border:'none', color:'#fff', fontSize:12, textDecoration:'none', fontWeight:600 }}>
